...
import { Rocket, CheckCircle, Target, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 px-6 bg-gradient-to-r from-orange-50 to-orange-100">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-12 max-w-3xl mx-auto">
            Creamos aplicaciones web modernas, rápidas y escalables que impulsan tu negocio al siguiente nivel.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-xl text-gray-600">
              Desde landing pages hasta plataformas complejas, adaptamos cada proyecto a tus necesidades.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Interfaces modernas, interactivas y altamente escalables.",
              },
              {
                icon: CheckCircle,
                title: "E-commerce y tiendas online",
                description: "Tiendas seguras y optimizadas para aumentar tus ventas.",
              },
              {
                icon: Target,
                title: "Dashboards y Analytics",
                description: "Visualización de datos clara y funcional para tomar decisiones estratégicas.",
              },
              {
                icon: Zap,
                title: "Optimización y Rendimiento",
                description: "Websites rápidos, confiables y amigables con SEO.",
              }
            ].map((feature, idx) => {
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-gray-900 to-black text-white text-center">
        ...
        <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
          Agenda una consultoría gratuita y descubre cómo podemos llevar tu idea a la web.
        </p>
        <Link
          href="/contact"
