            ...
            <section className="relative pt-32 pb-20 px-6 bg-gradient-to-r from-orange-50 to-orange-100">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-700 mb-12 max-w-3xl mx-auto">
                        Transformamos tu negocio con soluciones de inteligencia artificial y automatización que optimizan procesos y mejoran la toma de decisiones.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                            Soluciones inteligentes personalizadas
                        </h2>
                        <p className="text-xl text-gray-600">
                            Desde chatbots hasta análisis predictivo, implementamos tecnología de IA adaptada a tus necesidades específicas.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: "Atención al cliente automatizada disponible 24/7 con IA conversacional.",
                            },
                            {
                                icon: CheckCircle,
                                title: "Automatización de Procesos (RPA)",
                                description: "Automatización de tareas repetitivas para aumentar la eficiencia operativa.",
                            },
                            {
                                icon: Target,
                                title: "Análisis Predictivo y Machine Learning",
                                description: "Modelos de IA que predicen tendencias y optimizan decisiones de negocio.",
                            },
                            {
                                icon: Zap,
                                title: "Procesamiento de Lenguaje Natural",
                                description: "Análisis de texto y sentimientos para mejorar la experiencia del cliente.",
                            }
                        ].map((feature, idx) => {
