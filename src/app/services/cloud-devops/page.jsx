...
import { Cloud, CheckCircle, Target, Zap } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative pt-32 pb-20 px-6 bg-gradient-to-r from-orange-50 to-orange-100">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-700 mb-12 max-w-3xl mx-auto">
                        Optimizamos tu infraestructura en la nube con soluciones escalables, seguras y automatizadas para maximizar el rendimiento de tu negocio.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                            Soluciones cloud personalizadas
                        </h2>
                        <p className="text-xl text-gray-600">
                            Desde migración a la nube hasta automatización de despliegues, diseñamos infraestructuras robustas y eficientes.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: Cloud,
                                title: "Infraestructura en AWS, Azure y GCP",
                                description: "Diseño y administración de infraestructuras cloud escalables y seguras.",
                            },
                            {
                                icon: CheckCircle,
                                title: "CI/CD y Automatización",
                                description: "Pipelines de integración y despliegue continuo para acelerar entregas.",
                            },
                            {
                                icon: Target,
                                title: "Monitoreo y Optimización",
                                description: "Supervisión 24/7 y optimización de recursos para reducir costos.",
                            },
                            {
                                icon: Zap,
                                title: "Contenedores y Kubernetes",
                                description: "Orquestación de contenedores para aplicaciones altamente disponibles.",
                            }
                        ].map((feature, idx) => {
            ...
            <section className="py-24 px-6 bg-gradient-to-br from-gray-900 to-black text-white text-center">
                ...
                <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
                    Agenda una consultoría gratuita y descubre cómo optimizar tu infraestructura tecnológica.
                </p>
                <Link
                    href="/contact"
